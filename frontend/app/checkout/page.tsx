...
import { Smartphone, ArrowLeft, ShieldCheck, MapPin, Phone } from "lucide-react";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-card-bg rounded-2xl sm:rounded-3xl border border-card-border p-5 sm:p-7 lg:sticky lg:top-24">
                                    ...
                                    <div key={item.id} className="flex items-center gap-3">
                                        <div className="w-12 h-12 sm:w-14 sm:h-14 bg-background border border-card-border rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden">
                                            {item.imagenes && item.imagenes.length > 0 ? (
                                                <img src={item.imagenes[0]} alt="" className="w-10 h-10 object-contain mix-blend-multiply dark:mix-blend-normal" />
                                            ) : (
                            ...
                            <div className="border-t border-dashed border-card-border pt-5">
                                ...
                                <p className="text-xs text-foreground/40 text-right mt-1.5">Envío gratis a todo el país</p>
                            </div>
                        </div>
                    </div>
                </div>
